...
OV.NavCubeInteraction.prototype.OnTouchEnd=function(a){a.preventDefault();this.touch.End(this.canvas,a);this.clickDetector.Up(a);this.clickDetector.IsClick()&&(a=OV.GetClientCoordinates(this.canvas,a.changedTouches[0].clientX,a.changedTouches[0].clientY),this.navCube.Intersect(a),this.navCube.Click())};

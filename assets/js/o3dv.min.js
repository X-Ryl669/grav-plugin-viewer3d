...
OV.ViewerGeometry.prototype.SetMeshVisibility=function(a,b){a.visible!==b&&(a.visible=b,a=this.modelMeshes.indexOf(a),this.edgesMeshes.length>a&&(this.edgesMeshes[a].visible=b))};OV.Viewer=function(){this.upVector=this.navigation=this.light=this.camera=this.geometry=this.scene=this.renderer=this.canvas=null;this.settings={animationSteps:40}};OV.Viewer.prototype.UpdateEdgesSettings=function(a){this.geometry.edgesSettings=Object.assign({},a)};
...
OV.Viewer.prototype.GetMeshUserDataUnderMouse=function(a){a=this.geometry.GetModelMeshUnderMouse(a,this.camera,this.canvas.width,this.canvas.height);return null===a?null:a.userData};OV.Viewer.prototype.GetBoundingBox=function(a){var b=!1,c=new THREE.Box3;this.geometry.EnumerateModelMeshes(function(d){a(d.userData)&&(c.union((new THREE.Box3).setFromObject(d)),b=!0)});return b?c:null};

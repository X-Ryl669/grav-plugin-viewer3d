...
OV.Navigation.prototype.OnTouchMove=function(a){a.preventDefault();this.touch.Move(this.canvas,a);if(this.touch.IsFingerDown()){this.onMove&&this.Move(a.clientX,a.clientY);a=this.touch.GetMoveDiff();var b=this.touch.GetDistanceDiff(),c=this.touch.GetFingerCount();1===c?this.Orbit(.5*a.x,.5*a.y):2===c&&(this.Zoom(.005*b),b=.001*OV.CoordDistance3D(this.camera.eye,this.camera.center),this.Pan(a.x*b,a.y*b));this.Update()}};
OV.Navigation.prototype.OnTouchEnd=function(a){a.preventDefault();this.touch.End(this.canvas,a)};OV.Navigation.prototype.OnMouseWheel=function(a){a.preventDefault();var b=a||window.event;a=0;b.detail?a=-b.detail:b.wheelDelta&&(a=b.wheelDelta/40);b=.1;0>a&&(b*=-1);this.Zoom(b);this.Update()};OV.Navigation.prototype.OnContextMenu=function(a){a.preventDefault()};

...
class V3DShortcode extends Shortcode
{
    public function init()
    {
        $this->shortcode->getHandlers()->add('3dv', function(ShortcodeInterface $sc) {
            ...
            return "<div class='online_3d_viewer' data-base='".$baseUrl."/' model='".$slug.'/'.$sc->getContent()."' camera='-1.5,-3.0,2.0,0,0,0,0,0,1'".($showEdges ? " edge='#000000'" : "")." color='#A0B0A0'><div class='toolbar'></div><div class='details'></div></div>";
        });
    }
}
